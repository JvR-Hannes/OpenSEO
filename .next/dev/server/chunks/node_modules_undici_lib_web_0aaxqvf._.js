...
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { cloneResponse, fromInnerResponse, getResponseState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/response.js [app-route] (ecmascript)");
const { Request, fromInnerRequest, getRequestState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/request.js [app-route] (ecmascript)");
const { fetching } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/index.js [app-route] (ecmascript)");
const { urlIsHttpHttpsScheme, readAllBytes } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { createDeferredPromise } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/promise.js [app-route] (ecmascript)");
/**
...
const { collectASequenceOfCodePointsFast } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
 ...
 */ function isLetterOrDigit(code) {
    return code >= 0x30 && code <= 0x39 || code >= 0x41 && code <= 0x5A || code >= 0x61 && code <= 0x7A // a-z
    ;
}
/**
...
const { ReadableStreamFrom, readableStreamClose, fullyReadBody, extractMimeType } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { FormData, setFormDataState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/formdata.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
...
const { createDeferredPromise } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/promise.js [app-route] (ecmascript)");
const { parseJSONFromBytes } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
const { utf8DecodeBytes } = __turbopack_context__.r("[project]/node_modules/undici/lib/encoding/index.js [app-route] (ecmascript)");
...
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { forgivingBase64, collectASequenceOfCodePoints, collectASequenceOfCodePointsFast, isomorphicDecode, removeASCIIWhitespace, removeChars } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
...
const { bufferToLowerCasedHeaderName } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { HTTP_TOKEN_CODEPOINTS } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { makeEntry } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/formdata.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { isomorphicDecode } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
...
const { iteratorMixin } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
...
// https://github.com/Ethan-Arrowood/undici-fetch
const { makeNetworkError, makeAppropriateNetworkError, filterResponse, makeResponse, fromInnerResponse, getResponseState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/response.js [app-route] (ecmascript)");
const { HeadersList } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/headers.js [app-route] (ecmascript)");
const { Request, cloneRequest, getRequestDispatcher, getRequestState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/request.js [app-route] (ecmascript)");
const zlib = __turbopack_context__.r("[externals]/node:zlib [external] (node:zlib, cjs)");
const { makePolicyContainer, clonePolicyContainer, requestBadPort, TAOCheck, appendRequestOriginHeader, responseLocationURL, requestCurrentURL, setRequestReferrerPolicyOnRedirect, tryUpgradeRequestToAPotentiallyTrustworthyURL, createOpaqueTimingInfo, appendFetchMetadata, corsCheck, crossOriginResourcePolicyCheck, determineRequestsReferrer, coarsenedSharedCurrentTime, sameOrigin, isCancelled, isAborted, isErrorLike, fullyReadBody, readableStreamClose, urlIsLocal, urlIsHttpHttpsScheme, urlHasHttpsScheme, clampAndCoarsenConnectionTimingInfo, simpleRangeHeaderValue, buildContentRange, createInflate, extractMimeType, hasAuthenticationEntry, includesCredentials, isTraversableNavigable } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
...
const { addAbortListener, bufferToLowerCasedHeaderName } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
...
const { bytesMatch } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/subresource-integrity/subresource-integrity.js [app-route] (ecmascript)");
const { createDeferredPromise } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/promise.js [app-route] (ecmascript)");
const { isomorphicEncode } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
const { runtimeFeatures } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/runtime-features.js [app-route] (ecmascript)");
...
function fetching({ request, processRequestBodyChunkLength, processRequestEndOfBody, processResponse, processResponseEndOfBody, processResponseConsumeBody, useParallelQueue = false, dispatcher = getGlobalDispatcher(), requestObject = null // Keep alive to prevent AbortController GC, see #4627
 }) {
...
/* globals AbortController */ const { extractBody, mixinBody, cloneBody, bodyUnusable } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/body.js [app-route] (ecmascript)");
...
const { extractBody, cloneBody, mixinBody, streamRegistry, bodyUnusable } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/body.js [app-route] (ecmascript)");
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const nodeUtil = __turbopack_context__.r("[externals]/node:util [external] (node:util, cjs)");
const { kEnumerableProperty } = util;
const { isValidReasonPhrase, isCancelled, isAborted, isErrorLike, environmentSettingsObject: relevantRealm } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
...
const { kConstruct } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { isomorphicEncode, serializeJavascriptValueToJSONString } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
...
const { Transform } = __turbopack_context__.r("[externals]/node:stream [external] (node:stream, cjs)");
const zlib = __turbopack_context__.r("[externals]/node:zlib [external] (node:zlib, cjs)");
const { redirectStatusSet, referrerPolicyTokens, badPortsSet } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/constants.js [app-route] (ecmascript)");
const { getGlobalOrigin } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/global.js [app-route] (ecmascript)");
const { collectAnHTTPQuotedString, parseMIMEType } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { performance } = __turbopack_context__.r("[externals]/node:perf_hooks [external] (node:perf_hooks, cjs)");
const { ReadableStreamFrom, isValidHTTPToken, normalizedMethodRecordsBase } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { isUint8Array } = __turbopack_context__.r("[externals]/node:util/types [external] (node:util/types, cjs)");
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { isomorphicEncode, collectASequenceOfCodePoints, removeChars } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
...
"[project]/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/web/subresource-integrity/subresource-integrity.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { parseExtensions, isClosed, isClosing, isEstablished, isConnecting, validateCloseCodeAndReason } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { makeRequest } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/request.js [app-route] (ecmascript)");
const { fetching } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/index.js [app-route] (ecmascript)");
...
const { runtimeFeatures } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/runtime-features.js [app-route] (ecmascript)");
const { maxUnsigned16Bit, opcodes } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
...
const { MessageSizeExceededError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
...
const { isValidStatusCode, isValidOpcode, websocketMessageReceived, utf8Decode, isControlFrame, isTextBinaryFrame, isContinuationFrame } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { failWebsocketConnection } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/connection.js [app-route] (ecmascript)");
const { WebsocketFrameSend } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/frame.js [app-route] (ecmascript)");
...
"[project]/node_modules/undici/lib/web/websocket/stream/websocketerror.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { validateCloseCodeAndReason } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { kConstruct } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
...
"[project]/node_modules/undici/lib/web/websocket/stream/websocketstream.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { createDeferredPromise } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/promise.js [app-route] (ecmascript)");
const { environmentSettingsObject } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { states, opcodes, sentCloseFrameState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { getURLRecord, isValidSubprotocol, isEstablished, utf8Decode } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { establishWebSocketConnection, failWebsocketConnection, closeWebSocketConnection } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/connection.js [app-route] (ecmascript)");
...
const { WebSocketError, createUnvalidatedWebSocketError } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/stream/websocketerror.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { utf8DecodeBytes } = __turbopack_context__.r("[project]/node_modules/undici/lib/encoding/index.js [app-route] (ecmascript)");
...
const { removeHTTPWhitespace } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { collectASequenceOfCodePointsFast } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
/**
...
const { URLSerializer } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { environmentSettingsObject } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { staticPropertyDescriptors, states, sentCloseFrameState, sendHints, opcodes } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
const { isConnecting, isEstablished, isClosing, isClosed, isValidSubprotocol, fireEvent, utf8Decode, toArrayBuffer, getURLRecord } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { establishWebSocketConnection, closeWebSocketConnection, failWebsocketConnection } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/connection.js [app-route] (ecmascript)");
const { ByteParser } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/receiver.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { getGlobalDispatcher } = __turbopack_context__.r("[project]/node_modules/undici/lib/global.js [app-route] (ecmascript)");
const { ErrorEvent, CloseEvent, createFastMessageEvent } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/events.js [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_undici_lib_web_0aaxqvf._.js.map