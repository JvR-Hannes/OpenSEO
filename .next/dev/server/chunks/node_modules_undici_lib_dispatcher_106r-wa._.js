...
const { InvalidArgumentError, MaxOriginsReachedError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { kClients, kRunning, kClose, kDestroy, kDispatch, kUrl } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
...
const Pool = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)");
const { kUrl } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const kFactory = Symbol('factory');
const kOptions = Symbol('options');
...
function lazyllhttp() {
    ...
    if (useWasmSIMD) {
        try {
            mod = new WebAssembly.Module(__turbopack_context__.r("[project]/node_modules/undici/lib/llhttp/llhttp_simd-wasm.js [app-route] (ecmascript)"));
        } catch  {}
    }
    if (!mod) {
        ...
        mod = new WebAssembly.Module(llhttpWasmData || __turbopack_context__.r("[project]/node_modules/undici/lib/llhttp/llhttp-wasm.js [app-route] (ecmascript)"));
    }
...
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { RequestContentLengthMismatchError, RequestAbortedError, SocketError, InformationalError, InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { kUrl, kReset, kClient, kRunning, kPending, kQueue, kPendingIdx, kRunningIdx, kError, kSocket, kStrictContentLength, kOnError, kMaxConcurrentStreams, kPingInterval, kHTTP2Session, kHTTP2InitialWindowSize, kHTTP2ConnectionWindowSize, kResume, kSize, kHTTPContext, kClosed, kBodyTimeout, kEnableConnectProtocol, kRemoteSettings, kHTTP2Stream, kHTTP2SessionState } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
...
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { ClientStats } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/stats.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
 ...
 */ class Client extends DispatcherBase {
   ...
   */ constructor(url, { maxHeaderSize, headersTimeout, socketTimeout, requestTimeout, connectTimeout, bodyTimeout, idleTimeout, keepAlive, keepAliveTimeout, maxKeepAliveTimeout, keepAliveMaxTimeout, keepAliveTimeoutThreshold, socketPath, pipelining, tls, strictContentLength, maxCachedSessions, connect, maxRequestsPerClient, localAddress, maxResponseSize, autoSelectFamily, autoSelectFamilyAttemptTimeout, // h2
    maxConcurrentStreams, allowH2, useH2c, initialWindowSize, connectionWindowSize, pingInterval, webSocket } = {}){
...
const UnwrapHandler = __turbopack_context__.r("[project]/node_modules/undici/lib/handler/unwrap-handler.js [app-route] (ecmascript)");
...
const { kDestroy, kClose, kClosed, kDestroyed, kDispatch } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/h2c-client.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { PoolStats } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/stats.js [app-route] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
...
const { PoolBase, kClients, kNeedDrain, kAddClient, kGetDispatcher, kRemoveClient } = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool-base.js [app-route] (ecmascript)");
const Client = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/client.js [app-route] (ecmascript)");
const { InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { kUrl } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
...
const { kProxy, kClose, kDestroy, kDispatch } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const Agent = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/agent.js [app-route] (ecmascript)");
const Pool = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
...
const Client = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/client.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
const Socks5ProxyAgent = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/socks5-proxy-agent.js [app-route] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/round-robin-pool.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/dispatcher/socks5-proxy-agent.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
const { InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { Socks5Client, STATES } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/socks5-client.js [app-route] (ecmascript)");
const { kDispatch, kClose, kDestroy } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const Pool = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)");
const buildConnector = __turbopack_context__.r("[project]/node_modules/undici/lib/core/connect.js [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_undici_lib_dispatcher_106r-wa._.js.map